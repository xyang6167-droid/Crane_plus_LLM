...
def main():
    ...
    parser.add_argument('--model_path', default=r'D:\project_nju\CranePlus\thinking_distill_768.pth', type=str, help="模型权重路径（.pth文件）")
    ...
    parser.add_argument('--top_p', default=0.8, type=float, help="nucleus采样阈值")
    parser.add_argument('--repetition_penalty', default=1.3, type=float, help="重复惩罚（越大越抑制重复，1.0=不惩罚）")
